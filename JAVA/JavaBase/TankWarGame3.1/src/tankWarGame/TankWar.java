...
public class TankWar extends Frame{
	 ...
	 *测试版
	 */
	public static final int GAME_WIDTH = Toolkit.getDefaultToolkit().getScreenSize().width;//800
	public static final int GAME_HEIGHT = Toolkit.getDefaultToolkit().getScreenSize().height;//600
	
	public static final Color WALLCOLOR = new Color(74,62,13);
	public int currentMap = 0;
	
	public static final int TANK_MAX_NUM = 121;//最多坦克数
	public int appendTankNum = 20;//附加坦克数
	...
	private static final boolean ISPLAYBGSND = true;//false
	...
	public void paint(Graphics g) {
		...
		*/
		...
		if(tanks.size() <= 0)
		{
			...
			appendTankNum = (5+appendTankNum)%TANK_MAX_NUM;
			currentMap = (1+currentMap)%4;
			...
			for(int i=0;i<appendTankNum;i++)//控制坦克数量
			{
